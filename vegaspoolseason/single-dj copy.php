...
<!-- Page Title, Category, Post Information ================================================== -->
    <h1 class="blogtitle entry-title" style="margin:0;" itemprop="itemReviewed" itemscope itemtype="http://schema.org/Thing"><span itemprop="name"><?php wp_title("",true); ?></span></h1>
    <p><?php echo do_shortcode('[ct id="ct_City_text_4645" property="title | description | value"]'); ?></p>
    <div class="clear"></div>
    <p><img src="<?php echo do_shortcode('[ct id="_ct_text_511d1555060cb" property="title | description | value"]'); ?>"></p>
    <div class="clear"></div>

...
<!-- Page Title, Category, Post Information ================================================== -->
        ...
        <a class="bubble comments" href=" <?php comments_link(); ?> ">
          <?php comments_number( __('No Comments', 'framework'), __('One Comment', 'framework'), __('% Comments', 'framework') ); ?></a>
        <div class="clear"></div>
          <?php endif; ?>
        <div class="clear"></div>
...
<!-- THE NEXT AND PREVIOUS POST LINKS -->
          <?php the_previousnextlinks(); // declared in extra-functions.php

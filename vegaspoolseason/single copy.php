        ...
        if ($author_style == 'Avatar Box' || $author_style == 'avatar_box' || ($author_style == '' && $default_style == 'avatar_box') ) : ?>
          ...
          /* Author
            ...
            if ($author_style == 'Simple' || $author_style == 'simple' || ($author_style == '' && $default_style == 'simple') ) : ?>
                ...
                $author_name = get_the_author_meta('display_name');
                $author_url = get_the_author_meta('user_url');  ?>
               <p><a href="<?php echo get_author_posts_url( $author_id ); ?>"  itemprop="author" target="_blank"><?php the_author(); ?></a> | <?php _e('On', 'framework');?> <?php the_time('d'); ?>, <?php the_time('M'); ?>  <?php the_time('Y'); ?></p>
  		      <?php endif; ?>

         <!-- Content
           ================================================== -->
          <?php the_content(); ?>
          <h2>Download Our Vegas Pool Party Guide</h2>
            <a href="http://vegaspoolseason.com/download-our-vegas-pool-party-guide"><img src="http://vegaspoolseason.com/wp-content/uploads/2015/01/vegas-pool-guide-2015.jpg" alt="Vegas Pool Party Guide" /></a>
            <hr>
            <a rel="nofollow" href="http://click.linksynergy.com/fs-bin/click?id=iGXr5GOhHoE&offerid=315171.12&subid=0&type=4"><IMG border="0" alt="bikini.com" src="http://ad.linksynergy.com/fs-bin/show?id=iGXr5GOhHoE&bids=315171.12&subid=0&type=4&gridnum=1"></a>
